...
def load_models(
    ...
    load_ghsolv: bool = True, #True
    load_g: bool = True, #True
    load_h: bool = False, #True
    load_saq: bool = True, #True
    load_solute: bool = True, #True
    logger=None,
) -> SolubilityModels:
    """
...
def predict_property(
    ...
    hsolv: bool = False,
    saq: bool = True,
    solute_parameters: bool = True, #Originally false
    reduced_number: bool = False,
...
def calculate_solubility(
    ...
    calculate_Hdiss_T_dep: bool = False, #false before
    validate_data_list: list = [],
    reduced_number: bool = False,
    export_csv: str = None,
    ...
    calculate_t_dep_with_t_dep_hdiss = predict_t_dep and calculate_Hdiss_T_dep #Try new conditinal statement
...
def write_results(
    ...
    """
    if predictions:
        if predictions.ghsolv is not None:
            df["dG_solv_298 [kcal/mol]"] = [i for i in predictions.ghsolv[0]] #ghsolv 
            df["stdev_dG_solv_298 [kcal/mol]"] = [
                np.sqrt(i) for i in predictions.ghsolv[1] #Here
            ]
        ...
        if calculations is not None:
            ...
            if calculations.logs_T_with_const_hdiss_from_ref is not None:
                df[
                    "logS_T_from_ref_with_constant_Hdiss [log10(mol/L)]" #here
