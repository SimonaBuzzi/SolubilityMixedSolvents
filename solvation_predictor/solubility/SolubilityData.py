...
class SolubilityData:
    def __init__(
        ...
        """
        # molefracs are not calcualted on the go?
        self.df = df
        self.smiles_solvents1 = []
        self.smiles_solvents2 = None
        self.smiles_solvents3 = None
        self.smiles_solutes = []
        self.molefracs = []
        self.molefracs2 = []
...
#############################################################################
    def get_data_from_df(self, verbose=False):
        ...
        if "solvent3_smiles" in self.df.columns:
            self.smiles_solvents3 = self.df["solvent3_smiles"].values.tolist()
            self.molefracs2 = self.df["molefrac2"].values.tolist()
