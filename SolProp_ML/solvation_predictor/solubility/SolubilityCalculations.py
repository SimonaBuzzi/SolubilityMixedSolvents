...
class SolubilityCalculations:
    ...
    def make_calculations_298(
        ...
        if predictions.ghsolv:
            ...
            # print(f"gsolv_298 = {self.gsolv_298}")
            # print(f"gsolv_298_unc = {self.unc_gsolv_298}")
    ...
    def make_calculations_t(
        ...
        if predictions.ghsolv:
            ...
            self.hsolv_298, self.unc_hsolv_298 = self.hsolv_298[:, 1], self.unc_hsolv_298[:, 1]
            
            # print(f"hsolv_298: {self.hsolv_298}")
            # print(f"hsolv_298_unc: {self.unc_hsolv_298}")
    ...
    def calculate_logs_t(
        self, hsolv_298=None, hsubl_298=None, logs_298=None, temperatures=None #Debug here
    ):
        print(f"hsolv_298: {hsolv_298}")
        print(f"hsubl_298: {hsubl_298}")
        print(f"logs_298: {logs_298}")
        print(f"temperatures: {temperatures}")

        hdiss_298 = hsolv_298 + hsubl_298
        
        print(f"hdiss_298: {hdiss_298}")
    ...
    def get_hsubl_298(
        ...
        if in_kcal == True:
            hsubl_298 = hsubl_298 / 4.184  # convert to kcal/mol
        return hsubl_298
    
    def parse_molecule(self, input_string):
        
        """ Parses the input string into an RDKit molecule. I
        It handles both InChIs and SMILES """
        ...
        if mol is None:
            raise ValueError(f"Invalid chemical input string: {input_string}")
        return mol


    def calculate_solute_parameter_v(self, solute_smiles):
        
        mol = self.parse_molecule(solute_smiles)
    ...
    def get_individual_diol_amine_ids(self, solute):
        ...
        if solute.startswith("InChI="):
             mol = Chem.MolFromInchi(solute)  # For InChI strings
        else:
            mol = Chem.MolFromSmiles(solute)  # For SMILES strings

        # Check if mol is None (invalid InChI or SMILES string)
        if mol is None:
            raise ValueError(f"Invalid SMILES or InChI string: {solute}")
